  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="text-center py-12">
        ...
        <p className="text-xl text-gray-600">Portal Login Calon Mentor</p>
      </div>
    ...
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-green-400 to-green-600 p-6 text-center">
        ...
        <p className="text-green-100">
          Masuk ke portal belajar Science Society
        </p>
      </div>
      ...
      <div className="p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Calon Mentor@sciencesociety.com"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-green-400 to-green-600 text-white py-3 px-4 rounded-lg font-bold font-montserrat transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 hover:from-green-500 hover:to-green-700 flex items-center justify-center"
          >
            Masuk Portal Calon Mentor
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="mt-6 text-center space-y-3">
          ...
          <Link
            to="/Daftar"
            className="w-full bg-white border border-green-500 text-green-600 py-3 px-4 rounded-lg font-medium transition-all duration-300 hover:bg-green-50 flex items-center justify-center"
          >
            Daftar Akun Baru
            <svg
              xmlns="http://www.w3.org/2000/svg"
