  ...
  return (
    <div className="relative flex h-screen w-full flex-col rounded-xl bg-gray-900 bg-clip-border p-4 text-gray-100 shadow-xl shadow-black/20">
      ...
      <nav className="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-gray-300">
        <Link to="/Dashboard">
          <button className="flex items-center w-full p-3 leading-tight transition-all rounded-lg outline-none text-start hover:bg-gray-700 hover:bg-opacity-80 hover:text-gray-100 focus:bg-gray-700 focus:bg-opacity-80 focus:text-gray-100 active:bg-gray-700 active:bg-opacity-80 active:text-gray-100 cursor-pointer">
